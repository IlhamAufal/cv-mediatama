...
@section('content')
    <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Ubah informasi pengguna sesuai kebutuhan. Kosongkan password jika tidak ingin diubah.
                </p>
            </div>
            <div>
        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST" class="space-y-5">
            ...
            {{-- Submit Button --}}
            <div class="pt-4 flex justify-end gap-3 mt-3">
                <button type="submit"
                    class="inline-flex items-center justify-center gap-2 rounded-lg bg-yellow-600 px-6 py-2.5 text-sm font-medium text-white hover:bg-yellow-700 transition">
